					...
					<div class="content">
						...
						<div class="row">
							<div class="span6">
								...
								<div id="notification">
									<div id="fail-message" class="alert alert-error" style="display: none;">
										<button class="close" data-dismiss="alert" href="#">×
										</button>
										<h4>
											<strong>Oops!</strong>
											Failed to update
									...
									<div id="success-message" class="alert fade in" style="display: none;">
										<button class="close" data-dismiss="alert" href="#">×
										</button>
										<p>
								...
								<form class="form-horizontal" id="pubman-organization-metadata-editor">
									<fieldset>
										...
										<div class="control-group">
											<label class="control-label" for="title">Organization Name
											</label>
											<div class="controls">
												<input class="span6" id="title" name="title" type="text"
													required="required" autofocus="autofocus" placeholder="Name of your organization">
										...
										<div class="control-group">
											<label class="control-label" for="alternative">Organization
												Alternative Name
											</label>
											<div class="controls">
												<input class="span6" id="alternative" name="alternative"
													type="text" size="45" placeholder="Alternative name of your organization">
													<xsl:attribute name="value"><xsl:value-of
										...
										<div class="control-group">
											<label class="control-label" for="type">Organization Type
											</label>
											<div class="controls">
												<input class="span6" id="type" name="organization-type"
													type="text" size="45"
										...
										<div class="control-group">
											...
											<div class="controls">
												<input class="span6" id="type" name="identifier" type="text"
													size="45" placeholder="pubman:ext">
													<xsl:attribute name="value"><xsl:value-of
										...
										<div class="control-group">
											...
											<div class="controls">
												<textarea class="span6" id="description" name="description"
													rows="5" placeholder="Short description about your organization">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input required="required" class="span6" id="city"
													name="city" type="text" placeholder="Munich">
													<xsl:attribute name="value"><xsl:value-of
														select="eterms:city" />
                          </xsl:attribute>
												</input>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input required="required" class="span6" id="country"
													name="country" type="text" placeholder="Germany">
													<xsl:attribute name="value"><xsl:value-of
										...
										<div class="control-group">
											<label class="control-label" for="coordinates">Geographical Location
											</label>
											<div class="controls">
												<input class="span6" id="coordinates" name="coordinates"
													type="text" placeholder="48°21′14″N 011°47′10″E">
													<xsl:attribute name="value"><xsl:value-of
										...
										<div class="control-group">
											...
											<div class="controls">
												<input required="required" min="1000-01-01" class="span6"
													id="start-date" name="start-date" type="date" placeholder="2012-03-30">
													<xsl:attribute name="value"><xsl:value-of
